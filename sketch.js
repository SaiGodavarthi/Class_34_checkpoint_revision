...
var score, score_img, score_2,score_1;
...
function preload()
{
  ...
  score_img = loadImage("empty.png")
  score_1 = loadImage("one_star.png")
  score_2 = loadImage("stars.png")
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope2 = new Rope(7,{x:360,y:90});


  blower = createImg("baloon2.png");
  blower.position(220,300)
  blower.size(100,100)
  ...
  star = createSprite(230,20,10,10)
